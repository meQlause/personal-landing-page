  ...
  return (
    <div className="edu-modal open" role="dialog" aria-modal="true" aria-labelledby="eduModalTitle">
      ...
      <div className="edu-modal-panel" style={{ '--edu-color': edu.color } as React.CSSProperties}>
        <button className="modal-close edu-modal-close" onClick={onClose} aria-label="Close education detail">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            <path d="M18 6L6 18M6 6l12 12" />
          </svg>
        </button>

        <div className="edu-modal-header" style={{ '--edu-color': edu.color } as React.CSSProperties}>
          <div className="edu-modal-icon" style={{ borderColor: edu.color, color: edu.color }}>
            {edu.icon}
          </div>
          <div className="edu-modal-header-text">
            ...
            <div className="edu-modal-inst-row">
              ...
              <span className="edu-modal-sep" aria-hidden="true">·</span>
