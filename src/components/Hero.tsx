          ...
          <div className="flex flex-col items-center text-center">
            <div className="space-y-6 py-12">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-xl mx-auto">
                I'm a passionate full-stack developer specialized in building exceptional digital experiences that are both functional and beautiful.
              </p>
              ...
              <div className="pt-8 flex items-center justify-center space-x-6">
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white transition-colors duration-200">
                  <Github size={24} />
